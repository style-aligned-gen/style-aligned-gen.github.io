const placesData = {
    ...
    "sf.png": "Golden Gate Bridge, San Francisco",
    "stonehenge.png": "Stonehenge",
    "sydney.png": "Sydney Opera",
    "fiorence.png": "Cathedral of Santa Maria del Fiore",
    "prague.png": "Prague",
    "rio.png": "Rio de Janeiro",
    "rome.png": "Colosseum",
    "seatle.png": "Space Needle, Seattle",
    "taj.png": "Taj Mahal",
    "fuji.png": "Mount Fuji",
    "giza.png": "Great Pyramid of Giza",
    "grand_canion.png": "Grand Canyon",
    "beij.png": "Forbidden City, Beijing",
    "ironer.png": "Flatiron Building, New York",
    "jerusalem.png": "Jerusalem",
    "liberty.png": "Statue of Liberty",
    "louvre.png": "Louvre Museum, Paris",
    "machu.png": "Machu Picchu, Peru",
    "grif.png": "Griffith Observatory, Los Angeles",
    "matterhorn.png": "Matterhorn, Swiss Alps",
    "golden.png": "Golden Temple, Kyoto",
    "moon.png": "The Moon",
    "niagara.png": "Niagara Falls",
    "nss.png": "Neuschwanstein Castle, Bavaria",
    "ny.png": "Empire State Building, New York",
    "paris.png": "Eiffel Tower",
    "patagonia.png": "Perito Moreno Glacier, Patagonia",
    "ams.png": "Amsterdam",
    "aurora.png": "Aurora, Norway Fjords",
    "barcelone.png": "La Sagrada Familia, Barcelona",
    "berlin.png": "Alexanderplatz, Berlin",
    "budapest.png": "Parliament, Budapest",
    "burj.png": "Burj Khalifa, Dubai",
    "dracula.png": "Bran Castle (Dracula's Castle), Romania",
